...
echo. 
echo -----
echo Pulsa una tecla para comenzar a procesar los archivos de traducción…
pause > nul
echo. 
...
echo. 
echo Pulsa una tecla cuando termines para comenzar a compilar las traducciones...
pause > nul
echo. 
